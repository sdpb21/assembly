...
deuxieme: 		db "Debut du deuxieme programme - soustraction", 10, 10, 0
inciter: 		db "Entrez deux valeurs entieres : ", 0
difference:		db "La difference est %d", 10, 0
fin2:			db "Fin du deuxieme programme", 10, 10, 0
...
D: 			times 4 db 0 ; 32-bits integer = 4 bytes
